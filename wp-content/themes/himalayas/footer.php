   ...
   <footer id="colophon" class="footer-with-widget <?php echo $himalayas_footer_layout; ?>">
      ...
      <div id="disclaimer">
         <div class="tg-container">
            <b>Disclaimer: </b>Swamy is not a licensed physician/mental health clinician. The advice and counseling services provided by Swamy are not licensed by the state of California nor are they a substitute for licensed medical treatment.
         </div>
      </div>
