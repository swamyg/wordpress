...
service_list.push({"service":"GetResponse","fields":["webforms_id"]});
				...
				if(document.getElementById("pmie_button_selection_con") == null || jQuery('#pmie_button_selection_con').css('display') == 'none'){
	    		   ...
	    		   var button_select_div = "<div id='pmie_button_selection_con' ><div id='pmie_button_selection_inner' >" +
	   				...
	   				jQuery("#pmie_button_selection_inner").append("Button Text:<input type='text' id='pmie_btn_text' size='20' style='margin-bottom:10px;'><br>" +
	   					...
	   					"<tr>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_1' value='Txt' style='width:36px;height:36px;padding:0px'><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_2' value='Txt' style='width:36px;height:36px;padding:0px'><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_3' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_4' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"</tr>" +
	   					"<tr>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_5' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_6' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_7' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_8' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"</tr>" +
	   					"<tr>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_9' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_10' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_11' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_12' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"</tr>" +
	   					"<tr>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_13' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_15' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_17' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +
	   					"<td><input type='submit' id='pm_custm_btn' class='pm_custm_btn_19' value='Txt' style='width:36px;height:36px;padding:0px' ><td>" +						
	   					"</tr>" +
	   					"</table>");
					
					jQuery("[class^=pm_custm_btn_]").on("click",function(event){
						event.preventDefault();
						event.stopPropagation();	
					});
